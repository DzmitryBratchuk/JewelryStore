...
{
    public class CreateWatchModelValidator : AbstractValidator<CreateWatchModel>
    {
        public CreateWatchModelValidator()
        {
            ...
            RuleFor(x => x.DiameterInMillimeters).GreaterThan(0);

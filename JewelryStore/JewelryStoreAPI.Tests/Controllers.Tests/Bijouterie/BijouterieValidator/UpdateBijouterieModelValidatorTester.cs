...
{
    public class UpdateBijouterieModelValidatorTester
    {
        private readonly UpdateBijouterieModelValidator _validator;

        public UpdateBijouterieModelValidatorTester()
        {
            _validator = new UpdateBijouterieModelValidator();
        }

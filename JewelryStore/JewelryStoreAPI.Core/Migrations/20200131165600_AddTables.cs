    ...
    public partial class AddTables : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PreciousItemTypes", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    JewelryType = table.Column<int>(nullable: false),
                    BijouterieTypeId = table.Column<int>(nullable: true),
                    PreciousItemTypeId = table.Column<int>(nullable: true),
                    DiameterMM = table.Column<int>(nullable: true),
                    CaseColorId = table.Column<int>(nullable: true),
                    DialColorId = table.Column<int>(nullable: true),
                    StrapColorId = table.Column<int>(nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PreciousItems_To_PreciousItemTypes",
                        column: x => x.PreciousItemTypeId,
                        principalTable: "PreciousItemTypes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Products_PreciousItemTypeId",
                table: "Products",
                column: "PreciousItemTypeId");
